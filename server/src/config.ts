...
export const config = {
  ...
  model: {
     ...
     * provider. Defaults to Aicoo Standard, which every account can run and
     * which answers fast enough for a live town — Grok's reasoning deployment
     * regularly blew past the 90s timeout. Set TOWN_MODEL="grok-4" to opt a
     * Grok-enabled account in; accounts without access fall back automatically.
     */
